...
@section('content')
    <div class="row center-vertically">
        ...
        <br>
        <div class=" center-align fadeMeIn">
            <a class="waves-effect waves-light btn-large" href="auth/login">&nbsp;Login&nbsp;</a>
            <a class="waves-effect waves-light btn-large" href="auth/register">Sign up</a>
        </div>
        <br>
        <br>
